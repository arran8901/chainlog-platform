...
import (
	...
	"github.com/arran8901/chainlog-platform/docs"
	contractmodule "github.com/arran8901/chainlog-platform/x/contract"
	contractmodulekeeper "github.com/arran8901/chainlog-platform/x/contract/keeper"
	contractmoduletypes "github.com/arran8901/chainlog-platform/x/contract/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "chainlog"
	Name                 = "chainlog-platform"
)
...
var (
	...
	maccPerms = map[string][]string{
		...
		contractmoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner, authtypes.Staking},
...
func New(
	...
	app.ContractKeeper = *contractmodulekeeper.NewKeeper(
		...
		app.GetSubspace(contractmoduletypes.ModuleName),

		app.AccountKeeper,
		app.BankKeeper,
	)
	contractModule := contractmodule.NewAppModule(appCodec, app.ContractKeeper, app.AccountKeeper, app.BankKeeper)
